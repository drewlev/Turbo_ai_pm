...
// // ===== Components =====
// // this component isnt being used
// const DateButton = ({
//   date,
//   onValueChange,
// }: {
...
//         setUserContext({ userId: context.userId, role: context.role });
//       } catch (error) {
...
//     if (open && userContext) {
//       console.log("Fetching projects for user:", userContext.userId, "role:", userContext.role);
//       getActiveProjects(userContext.userId, userContext.role).then(
//         (activeProjects) => {
//           console.log("Raw active projects:", activeProjects);
...
//   console.log("Current project options:", projectOptions);
